...
const Features = () => {
      ...
      <div className="container mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg flex flex-col shadow-lg items-center transition-transform duration-200 hover:scale-102 hover:shadow-xl">
            ...
            <img src="/src/assets/icon1.png" alt="icon" /> {/* Image icon */}
            </div>
          ...
          <div className="bg-white p-6 rounded-lg flex flex-col shadow-lg items-center transition-transform duration-200 hover:scale-102 hover:shadow-xl">
            <div className="text-4xl text-rose-600 mb-4">
            <img src="/src/assets/icon2.png" alt="icon" /> {/* Image icon */}
            </div>
          ...
          <div className="bg-white p-6 rounded-lg flex flex-col shadow-lg items-center transition-transform duration-200 hover:scale-102 hover:shadow-xl">
            <div className="text-4xl text-rose-600 mb-4">
            <img src="/src/assets/icon3.png" alt="icon" /> {/* Image icon */}
            </div>
          ...
          <div className="bg-white p-6 rounded-lg flex flex-col shadow-lg items-center transition-transform duration-200 hover:scale-102 hover:shadow-xl">
            <div className="text-4xl text-rose-600 mb-4">
            <img src="/src/assets/icon4.png" alt="icon" /> {/* Image icon */}
            </div>
          ...
          <div className="bg-white p-6 rounded-lg flex flex-col shadow-lg items-center transition-transform duration-200 hover:scale-102 hover:shadow-xl">
            <div className="text-4xl text-rose-600 mb-4">
            <img src="/src/assets/icon5.png" alt="icon" /> {/* Image icon */}
            </div>
          ...
          <div className="bg-white p-6 rounded-lg flex flex-col shadow-lg items-center transition-transform duration-200 hover:scale-102 hover:shadow-xl">
            <div className="text-4xl text-rose-600 mb-4">
            <img src="/src/assets/icon6.png" alt="icon" /> {/* Image icon */}
            </div>
  ...
  <div className="p-6 flex flex-col items-center text-center ">
    {/* Logo */}
    <img src="/src/assets/logo7.png" alt="icon" className="w-20 md:w-24 mb-4" />
    ...
    {/* Profile Picture */}
    <img src="/src/assets/pfp2.png" alt="User Profile" className="w-14 h-14 md:w-16 md:h-16 rounded-full mb-2" />
